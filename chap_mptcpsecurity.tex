...
Secure MPTCP (SMTCP) refers to the integration of MPTCP with tcpcrypt, a protocol that attempts to encrypt almost the entire content of the traffic [\href{http://www.tcpcrypt.org/}{href}]
