...
Many techniques can be used to prevent the keys' eavesdrop attack other than the more obvious possibility of adopting pre-shared keys; such techniques are mentioned in \rfc{7430} and briefly explained here:

\begin{itemize}
  \item Use of hash chains: [];
  \item Use of SSL keys [];
  \item Use of Cryptographically Generated Addresses (CGAs) [];
  \item Use of tcpcrypt [];
  \item Use of DNSSEC [];
\end{itemize}
